...
-- Question 4 : Find the top 5 continents by average GNP per country.alter
...
SELECT c.Continent, COUNT(DISTINCT cl.Language) AS OfficialLanguageCount
FROM country c
...
SELECT Continent, AVG(ci.Population) AS AvgCityPop
FROM country c
JOIN city ci ON c.Code = ci.CountryCode
GROUP BY Continent
HAVING AvgCityPop > 200000;
